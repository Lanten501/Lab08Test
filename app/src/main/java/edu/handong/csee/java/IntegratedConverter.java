...
public class IntegratedConverter {
    ...
    /**
     * Main method that will execute the program
    ...
    /**
     * Method that will evaluate the input
     * and instanciate an objetc so we can use
     * all the required classes for convertions.
     * @param args
     */
